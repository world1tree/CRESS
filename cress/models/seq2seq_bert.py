...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        # self.mustc_token_type_embeddings = nn.Embedding(1, config.hidden_size)
...
@register_model_architecture(model_name="seq2seq_bert", arch_name="seq2seq_bert")
def base_architecture(args):
    args.bert_model_name = "bert-base-cased"